!function t(e, n, r) {
    ...
    1: [function(t, e, n) {
        var r, o = this && this.__extends || function(t, e) {
            function n() {
                this.constructor = t
            }
            for (var r in e)
            ...
            var r = {
              ...
              , s = function(t) {
                ...
                e.prototype.getWidth = function() {
                    ...
                    return this.element.removeAttribute("style"),
                    t
                }
                ,
                e
              ...
              , l = function() {
                ...
                return t.prototype.append = function(t) {
                    ...
                    this.elements = e(this.elements).concat([t]),
                    this.applyPosition("append", r, t)
                }
                ,
                t.prototype.prepend = function(t) {
                    ...
                    var r = this.findMinHeightColumn();
                    this.elements = [t].concat(e(this.elements)),
                    this.applyPosition("prepend", r, t)
                }
                ,
                t.prototype.on = function(t, e) {
                    return this.element.addEventListener("bricklayer." + t, e),
                    this
                }
                ,
                t.prototype.redraw = function() {
                    var t = this.columnCount;
                    this.checkColumnCount(!1),
                    this.reorderElements(t),
                    n(this.element, "bricklayer.redraw", {
                        columnCount: t
                    })
                }
                ,
                ...
                t.prototype.build = function() {
                    this.ruler = new s(this.options.rulerClassName),
                ...
                t.prototype.reorderElements = function(t) {
                    ...
                    void 0 === t && (t = 1),
                    (t == 1 / 0 || 1 > t) && (t = 1);
                    for (var r = e(this.elements).map(function(t) {
                        var e = t.parentNode ? t.parentNode.removeChild(t) : t;
                        return e
                    }), o = this.getColumns(), i = 0; i < o.length; i++)
                ...
                t.prototype.getColumnCount = function() {
                    ...
                    // 👇 修正ポイント：
                    // ruler の幅がまだ計算できていない場合（0やNaN）は列数を変えない
                    if (!e || e <= 0 || !isFinite(e)) {
                      // 直前の列数を維持（まだ安定していない段階）
                      return this.columnCount || 1;
                    }
                  
                    // 安定値を返す
                    var count = Math.round(t / e);
        ...
        function(t, n) {
            "function" == typeof define && define.amd ? define(function() {
                return n()
            }) : "undefined" != typeof window && t === window ? t.Bricklayer = n() : "object" == typeof e && e.exports && (e.exports = n())
